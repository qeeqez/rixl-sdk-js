 ...
 */
import type {GithubComRixlhqApiInternalVideosTypesChapterInput} from "./githubComRixlhqApiInternalVideosTypesChapterInput";

export interface UpdateChaptersRequest {
  chapters?: GithubComRixlhqApiInternalVideosTypesChapterInput[];
}
