...
export type GithubComRixlhqApiDbSqlcPlanType = (typeof GithubComRixlhqApiDbSqlcPlanType)[keyof typeof GithubComRixlhqApiDbSqlcPlanType];

export const GithubComRixlhqApiDbSqlcPlanType = {
  PlanTypeFree: "free",
  PlanTypePro: "pro",
