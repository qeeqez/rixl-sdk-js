...
class File {
     ...
     * @param {module:models/File} obj Optional instance to populate.
     * @return {module:models/File} The populated <code>File</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], FileStatus);
            }
